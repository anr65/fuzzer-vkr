...
php-fuzzer fuzz targetOld.php
# Run with initial corpus (one input per file)
php-fuzzer fuzz targetOld.php corpus/
```
...
```shell script
php-fuzzer minimize-crash targetOld.php crash-HASH.txt
```
...
```shell script
php-fuzzer run-single targetOld.php minimized-HASH.txt
```
...
```shell script
php-fuzzer report-coverage targetOld.php corpus/ coverage_dir/
```
